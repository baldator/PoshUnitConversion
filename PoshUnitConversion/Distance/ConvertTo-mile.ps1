function ConvertTo-mile{
    <#
	.SYNOPSIS
		Convert distance to miles.
	.DESCRIPTION
        Convert distance to miles. Input can be in m, km, cm, mm, foot, yard or in.
    .PARAMETER m
    ...
    try{
        $converter = [UnitConversion.distanceConverter]::new($TargetUnit, "mile")
        if($Precision){
