function ConvertTo-meter{
    <#
	.SYNOPSIS
		Convert distance to meters.
	.DESCRIPTION
        Convert distance to meters. Input can be in km, cm, mm, ft, yard, mile or in.
    .PARAMETER km
    ...
    try{
        $converter = [UnitConversion.distanceConverter]::new($TargetUnit, "m")
        if($Precision){
